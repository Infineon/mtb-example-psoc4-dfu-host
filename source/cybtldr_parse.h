...
/*
 * This Struct contains the pointer to the string array containing the FW image,
 * and number of lines present in the string array
 */
typedef struct{
 ...
 *
 *******************************************************************************/
EXTERN int CyBtldr_ParseRowData(uint32_t bufSize, char* buffer, uint32_t* address, uint8_t* rowData, uint16_t* size, uint8_t* checksum);

/*******************************************************************************
 * Function Name: CyBtldr_ParseAppStartAndSize
 ********************************************************************************
 * Summary:
 ...
 *
 *******************************************************************************/
EXTERN int CyBtldr_ParseAppStartAndSize(uint32_t* appStart, uint32_t* appSize, uint32_t* dataLines, char* buf);

/*******************************************************************************
 * Function Name: getLineCounter
 ********************************************************************************
 * Summary:
 *   returns the current line in operation of the String Image
 *   This function need to be called to know the value of current current line
 *
 * Returns:
 *   the value of line_counter
 *
 *******************************************************************************/
int getLineCounter();

/*******************************************************************************
 * Function Name: setLineCounter
 ********************************************************************************
 * Summary:
 *   sets the current line in operation of the String Image
 *   This function need to be called to set the value of current current line
 *
 * Parameters:
 *   num     - The current line value
 *
 * Returns:
 *   NULL
 *
...
/*******************************************************************************
 * Function Name: initFirmwareImage
 ********************************************************************************
 * Summary:
 *   initializes the string array pointer for reading the firmware image, number of rows present in the firmware image
 *   This function needs to be called before any cybtldr functions are called.
 *
 * Parameters:
 *   image     - The structure containing the pointer to the string array and the number of rows of the firmware image
 *
 * Returns:
 *   NULL
 *
